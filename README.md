...
In a future commit, a version of the program will be able to save files with tables of prime number sequences generated with lists of functions that will be ordered by their "prime spread" to build databases that can represent data as pure combinations of prime number equations.
